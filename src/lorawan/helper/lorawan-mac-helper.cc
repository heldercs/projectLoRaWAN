...
void LorawanMacHelper::SetAddressGenerator (Ptr<LoraDeviceAddressGenerator> addrGen){
...
Ptr<LorawanMac> LorawanMacHelper::Create (Ptr<Node> node, Ptr<NetDevice> device) const{
  	...
  	if (m_deviceType == ED_A){
    	Ptr<ClassAEndDeviceLorawanMac> edMac = mac->GetObject<ClassAEndDeviceLorawanMac> ();
      	switch (m_region){
        	...
        	break;
          	case LorawanMacHelper::Brazil:
				NS_LOG_DEBUG("ed Brazil");
            	ConfigureForBrazilRegion (edMac);
            break;
    	...
    	Ptr<GatewayLorawanMac> gwMac = mac->GetObject<GatewayLorawanMac> ();
      	switch (m_region){
            ...
            break;
         	case LorawanMacHelper::Brazil:
    			NS_LOG_DEBUG("gw Brazil");
            	ConfigureForBrazilRegion (gwMac);
            break;
        	case LorawanMacHelper::ALOHA:
...
void LorawanMacHelper::ConfigureForAlohaRegion (Ptr<ClassAEndDeviceLorawanMac> edMac) const{
...
void LorawanMacHelper::ConfigureForAlohaRegion (Ptr<GatewayLorawanMac> gwMac) const{
  	NS_LOG_FUNCTION_NOARGS ();

  	///////////////////////////////
  	// ReceivePath configuration //
  	///////////////////////////////
  	Ptr<GatewayLoraPhy> gwPhy = gwMac->GetDevice ()->GetObject<LoraNetDevice> ()->GetPhy ()->GetObject<GatewayLoraPhy> ();
...
void LorawanMacHelper::ApplyCommonAlohaConfigurations (Ptr<LorawanMac> lorawanMac) const{
	NS_LOG_FUNCTION_NOARGS ();
  	...
  	lorawanMac->SetBandwidthForDataRate (std::vector<double>{125000, 125000, 125000, 125000, 125000, 125000, 250000});
  	lorawanMac->SetMaxAppPayloadForDataRate (std::vector<uint32_t>{59, 59, 59, 123, 230, 230, 230, 230});
}

void LorawanMacHelper::ConfigureForEuRegion (Ptr<ClassAEndDeviceLorawanMac> edMac) const {
  	NS_LOG_FUNCTION_NOARGS ();
...
void LorawanMacHelper::ConfigureForEuRegion (Ptr<GatewayLorawanMac> gwMac) const {
	NS_LOG_FUNCTION_NOARGS ();
  	...
  	if (gwPhy){ // If cast is successful, there's a GatewayLoraPhy
    	NS_LOG_DEBUG ("EU Resetting reception paths");
      	gwPhy->ResetReceptionPaths ();
...
void LorawanMacHelper::ApplyCommonEuConfigurations (Ptr<LorawanMac> lorawanMac) const{
	NS_LOG_FUNCTION_NOARGS ();
...
void LorawanMacHelper::ConfigureForBrazilRegion (Ptr<ClassAEndDeviceLorawanMac> edMac) const {
  	NS_LOG_FUNCTION_NOARGS ();

  	ApplyCommonBrazilConfigurations (edMac);
...
void LorawanMacHelper::ConfigureForBrazilRegion (Ptr<GatewayLorawanMac> gwMac) const {
	NS_LOG_FUNCTION_NOARGS ();
  	...
  	ApplyCommonBrazilConfigurations (gwMac);
  	...
  	if (gwPhy){ // If cast is successful, there's a GatewayLoraPhy
    	NS_LOG_DEBUG ("Resetting reception paths");
      	...
      	std::vector<double> frequencies;
      	frequencies.push_back (915.2);
      	frequencies.push_back (915.4);
      	frequencies.push_back (915.6);
      	frequencies.push_back (915.8);
      	frequencies.push_back (916.0);
      	frequencies.push_back (916.2);
      	frequencies.push_back (916.4);
      	frequencies.push_back (916.6);
...
void LorawanMacHelper::ApplyCommonBrazilConfigurations (Ptr<LorawanMac> lorawanMac) const{
	NS_LOG_FUNCTION_NOARGS ();
	...
	NS_LOG_DEBUG("BR");
  	...
  	LogicalLoraChannelHelper channelHelper;
  	channelHelper.AddSubBand (915.1, 916.7, 0.01, 14);

  	//////////////////////
  	// Default channels //
  	//////////////////////
  	Ptr<LogicalLoraChannel> lc1 = CreateObject<LogicalLoraChannel> (915.2, 0, 5);
  	Ptr<LogicalLoraChannel> lc2 = CreateObject<LogicalLoraChannel> (915.4, 0, 5);
  	Ptr<LogicalLoraChannel> lc3 = CreateObject<LogicalLoraChannel> (915.6, 0, 5);
  	Ptr<LogicalLoraChannel> lc4 = CreateObject<LogicalLoraChannel> (915.8, 0, 5);
  	Ptr<LogicalLoraChannel> lc5 = CreateObject<LogicalLoraChannel> (916.0, 0, 5);
  	Ptr<LogicalLoraChannel> lc6 = CreateObject<LogicalLoraChannel> (916.2, 0, 5);
  	Ptr<LogicalLoraChannel> lc7 = CreateObject<LogicalLoraChannel> (916.4, 0, 5);
  	Ptr<LogicalLoraChannel> lc8 = CreateObject<LogicalLoraChannel> (916.6, 0, 5);
  	channelHelper.AddChannel (lc1);
  	channelHelper.AddChannel (lc2);
  	channelHelper.AddChannel (lc3);
  	channelHelper.AddChannel (lc4);
...
std::vector<int> LorawanMacHelper::SetSpreadingFactorsUp (NodeContainer endDevices, NodeContainer gateways,
...
std::vector<int> LorawanMacHelper::SetSpreadingFactorsEIB (NodeContainer endDevices, double rad){
  	NS_LOG_FUNCTION_NOARGS ();
...
std::vector<int> LorawanMacHelper::SetSpreadingFactorsEAB (NodeContainer endDevices, double rad){
  	NS_LOG_FUNCTION_NOARGS ();
...
std::vector<int> LorawanMacHelper::SetSpreadingFactorsStrategies (NodeContainer endDevices, std::vector<int> sfQuantity, 
...
std::vector<int> LorawanMacHelper::SetSpreadingFactorsProp (NodeContainer endDevices, double prop1, double prop2, double rad){
  	NS_LOG_FUNCTION_NOARGS ();
...
std::vector<int> LorawanMacHelper::SetSpreadingFactorsGivenDistribution (NodeContainer endDevices,
