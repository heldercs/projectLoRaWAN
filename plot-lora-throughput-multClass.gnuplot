...
plot filename2 using 1:3 w l ls 1 t 'SF7', filename5 using 1:3 ls 7 notitle
...
#plot filename using 1:9 w l ls 1 t 'avg SF789', filename1 using 1:9 w l ls 2 t 'avg SF789-EAB', filename2 using 1:9 w l ls 3 t 'avg SF789-Size', filename3 using 1:9 w l ls 4 t 'avg SF789-EAB-Size', filename4 using 1:3 w l ls 6 t 'only SF = 7' 
